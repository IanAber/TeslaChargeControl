...
///**
//KillHeater immeidately turns the heat off from where it is now
//*/
//func (h *HeaterSetting) killHeater() {
//	h.SetHeater(0)
//}
...
func (h *HeaterSetting) IncreasePump() {
	...
	startSolarPump() // In case the pump is stopped.
}
